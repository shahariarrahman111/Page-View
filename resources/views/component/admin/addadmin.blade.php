        ...
        <div class="container-fluid">
            <div class="page-content ">
                <div class="page-title">
                    <div>
                        <h5 class="fw-600">Add Admin</h5>
                    </div>

                </div>
                <div class="page-wrapper mt-3">
                    <div class="admin">
                        <div class="admin-form w-50">
                            <form action="">
                                ...
                                <div class="form-group position-relative mb-3">
                                    ...
                                    <input type="email" class="form-control is_error" id="email"
                                           placeholder="Email Address">
                                    <label for="" class="form-error-text">Invalid Email</label>
                                    <img src="../master_assets/images/master_icon/invalid_icon.svg" alt=""
                                ...
                                <div class="form-group position-relative mb-3">
                                    ...
                                    <textarea name="" id="address" cols="1" rows="2" class="form-control"></textarea>
                                </div>
                                <div class="form-group position-relative mb-3">
                                    ...
                                    <select class="select3">
                                        ...
                                        <option>Oparation Manager</option>
                                        <option>CEO</option>
                                    </select>
                                </div>
                                <div class="form-group position-relative mb-3">
                                    <label for="phone" class="form-label">Password</label>
                                    <input type="password" class="pass form-control" id="pass" placeholder="Password">
                                    <img src="assets/images/icon/form_lock.svg" alt="" class="w-auto h-auto form-icon">
                                </div>
                                <div class="form-group position-relative mb-3">
                                    <label for="confirm-password" class="form-label">Confirm-password</label>
                                    <input type="password" class="pass form-control" id="confirm-password"
