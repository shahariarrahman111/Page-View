            ...
            <div class="userDashboard d-flex">
                ...
                <div class="sidebarContent">
                    <div class="userAddress">
                        <div class="addUpdate_form">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <h5>Shipping address</h5>
                                <a href="address.html" class="anchorBtn-primary  btn-ex-sm">cancel</a>
                            </div>
                            <div>
                                <form action="#">
                                    <div class="form-group position-relative mb-3">
                                        <label for="name" class="form-label">Name</label>
                                        <input type="number" class="form-control" id="name" placeholder="Type your name">
                                    </div>
                                    <div class="form-group position-relative mb-3">
                                        <label for="phone" class="form-label">Phone Number/Email</label>
                                    ...
                                    <div class="form-group position-relative mb-3">
                                        ...
                                        <textarea class="form-control" name="" id="" cols="1" rows="2"></textarea>
                                    </div>

                                    <button type="button" class="btn btn-md w-100 btn-primary mt-3">Save</button>
                                </form>
                            </div>
                        </div>
                    </div>
