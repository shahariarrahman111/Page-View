                ...
                <div class="sidebarMenu">
                    <div class="userPanel mt-3">
                        ...
                        <ul class="navbar-nav d-flex  ">
                            ...
                            <li class="nav-item">
                                <a href="address.html" class="nav-link active" aria-current="page">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path class="address"
                ...
                <div class="sidebarContent">
                    <div class="userAddress">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="addaddress.html" class="anchorBtn-primary  btn-ex-sm">Add new</a>
                        </div>
                        <div class="addressList mt-3">
                            <div class="row">
                                <div class="col-4 ">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="card-checked d-flex justify-content-between align-items-center mt-3">
                                                <div class="alert alert-success-50 alert-ex-sm" role="alert">
                                                    Office
                                                </div>
                                                <div class="card-active d-flex align-items-center gap-1">
                                                    <img src="assets/images/icon/default_check.svg" alt=""
                                                         class="w-auto h-auto">
                                                    <span class="font-12">Default</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                <img src="assets/images/icon/3dots.svg" alt="" class="w-auto h-auto">
                                            </a>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-2"
                                                       href="addaddress.html"><img src="assets/images/icon/edit_icon_20.svg"
                                                                                   alt="" class="w-auto">
                                                        Edit</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-2" href="#"><img
                                                            src="assets/images/icon/active_card.svg" alt="" class="w-auto">
                                                        Active</a>
                                                </li>

                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-2" href="#">
                                                        <img src="assets/images/icon/delete_icon_20.svg" alt="" class="w-auto">
                                                        Delete</a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="card-checked d-flex justify-content-between align-items-center mt-3">
                                                <div class="alert alert-info-50 alert-ex-sm" role="alert">
                                                    Home
                                                </div>
                                                <div class="card-active d-flex align-items-center gap-1">
                                                    <img src="assets/images/icon/default_check.svg" alt=""
