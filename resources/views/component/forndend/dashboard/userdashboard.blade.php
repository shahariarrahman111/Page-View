        ...
        <div class="container-fluid">
            <div class="userDashboard d-flex">
                <div class="sidebarMenu">
                    <div class="userPanel mt-3">
                        ...
                        <ul class="navbar-nav d-flex  ">
                            <li class="nav-item">
                                <a href="userdashboard.html" class="nav-link active" aria-current="page">
                            ...
                            <li class="nav-item">
                                <a href="review.html" class="nav-link" aria-current="page">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path class="star"
                ...
                <div class="sidebarContent">
                    <div class="userOrderSummary ">
                        <div class="row">
                            <div class="col-3">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="assets/images/icon/new_order.svg" alt="" class="w-auto h-auto">
                                        <h6 class="card_title">New Order </h6>
                            ...
                            <div class="col-3">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="assets/images/icon/pending.svg" alt="" class="w-auto h-auto">
                                        <h6 class="card_title">Pending Order </h6>
                                        <div class="card_value d-flex justify-content-between align-items-center">
                                            <h5>150</h5>
                                        </div>
                                    </div>
                            ...
                            <div class="col-3">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="assets/images/icon/total_order.svg" alt="" class="w-auto h-auto">
                                        <h6 class="card_title">Total Order </h6>
                                        <div class="card_value d-flex justify-content-between align-items-center">
                                            <h5>100</h5>
                                        </div>
                                    </div>
                            ...
                            <div class="col-3">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="assets/images/icon/purchess.svg" alt="" class="w-auto h-auto">
                                        <h6 class="card_title">Total Purchase </h6>
                                        <div class="card_value d-flex justify-content-between align-items-center">
                                            <h5>15</h5>
                                        </div>
                                    </div>
                    ...
                    <div class="recentOrder mt-5">
                        <div class="myOrder">
                            <div class="pageTitle d-flex justify-content-between mb-3">
                                <h5>Recent order</h5>
                            </div>
                                ...
                                <div class="table">
                                    ...
                                    <div class="tbody">
                                        <div class="row">
                                            ...
                                            <div class="cell status">
                                                <div class="alert alert-warning-50 alert-sm" role="alert">
                                                    Pending
                                                </div>
                                            </div>
                                            <div class="cell action">
                                                <a href="orderdetails.html" class="btn btn-link font-14 fw-500">View</a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="cell sl">
