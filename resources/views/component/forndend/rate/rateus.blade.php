        ...
        <div class="container-fluid">
            <div class="userDashboard d-flex">
                <div class="sidebarMenu">
                    <div class="userPanel mt-3">
                        ...
                        <ul class="navbar-nav d-flex  ">
                            ...
                            <li class="nav-item">
                                <a href="order.html" class="nav-link " aria-current="page">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path class="order"
                            ...
                            <li class="nav-item">
                                <a href="review.html" class="nav-link active" aria-current="page">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path class="star"
                ...
                <div class="sidebarContent">
                    <div class="myRivew">
                        <div class="tableContainer rateus">
                            <div class="reviewItem row">
                                <div class="col-sm-12">
                                    <div class="orderInfo mb-3">
                                        <h6>Order ID : <span class="text-primary">783621ORDER</span> </h6>
                                        <p class="mt-1">Placed on : 12 December 2022 1:30 am</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <form action="">
                                        <div class="form-group position-relative mb-3">
                                            <label for="star" class="form-label">Rate Product</label>
                                        ...
                                        <div class="form-group position-relative mb-3">
                                            <label for="title" class="form-label">Write a Header</label>
                                            <input type="text" class="form-control" id="title" placeholder="Name">
                                        </div>
                                        <div class="form-group position-relative mb-3">
                                            <label for="address" class="form-label">Review Details</label>
                                            <textarea name="" id="address" cols="1" rows="2" class="form-control"
                                                      placeholder="Review Details"></textarea>
                                        </div>
                                        <div class="form-group position-relative mb-3">
                                            <label for="address" class="form-label">Photos</label>
                                                ...
                                                <div class="productMain-image">
                                                    <div class="dragDrop-area">
                                                        ...
                                                        <label
                                                            ...
                                                            for="files">
                                                            <img src="assets/images/icon/file_upload_icon.svg" alt=""
                                                                 class="w-auto h-auto">
                                                            <h6>Image upload</h6>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="image-preview-container d-flex gap-4">
                                                    <div class="uploadImage position-relative">
                                                        <img class="image-preview" src="assets/images/product4.png" alt="">
                                                        <img src="assets/images/icon/close_icon_upload_img.svg" alt=""
                                                             class="close-icon">
                                                    </div>
                                                    <div class="uploadImage position-relative">
                                                        <img class="image-preview" src="assets/images/product3.png" alt="">
                                                        <img src="assets/images/icon/close_icon_upload_img.svg" alt=""
                                                             class="close-icon">
                                                    </div>
                                                </div>
