                ...
                <div class="sidebarContent">
                    <div class="myRivew">
                        ...
                        <div class="tableContainer mt-3">
                            <div class="reviewItem row align-items-center">
                                <div class="col">
                                    <div class="d-flex flex-column">
                                        <p class="font-16 fw-500">Review Order</p>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="itemDetails d-flex align-items-center justify-content-between">
                                        <div class="price">
                                            <p class="font-16 fw-500">Amount</p>
                                        </div>
                                        <div class="satisfactory">
                                            <p class="font-16 fw-500">Satisfactory</p>
                                        </div>
                                        <div class="status">
                                            <p class="font-16 fw-500">Status</p>
                                        </div>
                                        <div class="action">
                                            <p class="font-16 fw-500">Action</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12 d-flex">
                                    ...
                                    <div class="col">
                                        <div class="itemDetails d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="action ">
                                                <a href="rateus.html" class="btn btn-link font-14 fw-500">Rate us</a>
                                ...
                                <div class="col-sm-12 d-flex">
                                    ...
                                    <div class="col">
                                        <div class="itemDetails d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="status ">
                                                <div class="alert alert-info-50 alert-sm" role="alert">
                                                    to reviewd
                                                </div>
                                            </div>
                                            <div class="action ">
